...
// once. The router (browser/react/index.js) generates its /vr routes from this — it maps each
...
// manifest that imported them back. The path→room-name derivation is in browser/navigate.js
// (currentRoom) for the same reason: browser/socket.js needs it without the component tree.
...
export function roomLabel (path) {
