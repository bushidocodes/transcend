...
const seedUsers = () => Promise.all([
  ...
  { name: 'Beth Qiang', displayName: 'Beth', email: 'beth@transcend.vr', password: '1234', skin: 'Iron-Man-Minecraft-Skin' },
  ...
  { name: 'Joe Cumins', displayName: 'Joe', email: 'joe@transcend.vr', password: '1234', skin: 'powerRanger' },
