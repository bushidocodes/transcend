// Token-guarded Minecraft skin loader, extracted from aframe-minecraft.js.
//
...
//
// `host` is the THREEx.MinecraftChar instance: it carries the mutable
// `_skinLoadSeq` token and the shared `texture`. `ImageCtor` defaults to the
// browser's window.Image so production behavior is unchanged.
export function loadSkinInto (host, url, onLoad, ImageCtor) {
