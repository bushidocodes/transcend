import { EVENTS, type Pose } from '../shared/protocol.ts';
import { setLocalSkin } from './avatars.ts';
...
export function addFirstPersonProperties(avatar: any, user: Pose): void {
  ...
  // corrects the move. Defaults match Room.tsx's 50x50 box (half-extent 25).
